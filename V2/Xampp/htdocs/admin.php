	...
	<div class = "nav_all">
		<div class = "nav_bar">
			<ul id = "menuItems" class = "nav">
			  ...
			  <li><a href="search_books.html">Explore</a></li>
			  <li><a href="BookCart.html">Bookcart</a></li>
		...
		<div class = "nav_bar_btn">
			<button class = "bkcart" onclick="location.href = 'BookCart.html';" ></button>
...
<div class = "lmenu">
	...
	<form class = "lmenu_form">
		...
		<br><br><br>
		<!--btn -->
		<a href='add_book.html' class = "addbtn" id = "Bookbtn" >Add Book</a>
		<a href='test.html' class = "addbtn" id = "Memberbtn" style = "display:none" >Add Member</a>
						...
						$res = mysqli_query($conn,$Bissue);
							...
							$status = $row2["status"];
								...
								if ($status == 'issue')
								{
									...
									echo '<img src = "../images/excuted.jpg" class = "icon" >';
									

									echo "<a href = 'delete.php?BookID=1'><img src = '../images/rejected.jpg' class = 'icon' >''</a>'" ;
