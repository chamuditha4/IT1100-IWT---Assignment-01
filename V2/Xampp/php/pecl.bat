...
FOR %%x IN ("C:\Users\Administrator\Documents\IT1100-IWT---Assignment-01\V2\Xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\Administrator\Documents\IT1100-IWT---Assignment-01\V2\Xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\Administrator\Documents\IT1100-IWT---Assignment-01\V2\Xampp\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\Administrator\Documents\IT1100-IWT---Assignment-01\V2\Xampp\php\php.exe"
GOTO :INSTALLED
