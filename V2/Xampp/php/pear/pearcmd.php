...
if ('C:\IT1100-IWT---Assignment-01\V2\Xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\IT1100-IWT---Assignment-01\V2\Xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
